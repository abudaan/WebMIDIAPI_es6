...
},{"./jazz":2,"./midi_input":4,"./midi_output":5}],4:[function(require,module,exports){
'use strict';
...
midiProc = function (timestamp, data) {
  ...
  for (i = 0; i < data.length; i += length) {
    ...
    var evt = {};
    if (_getDevice.getDevice().nodejs === false) {
...
},{"./midi_access":3,"./util":7}],7:[function(require,module,exports){
